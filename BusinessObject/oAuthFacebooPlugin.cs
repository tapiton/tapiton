...
public class oAuthFacebookPlugin
{
    ...
    //public static string Secret = "10691f7e98deeab41ed22f0bb5cd37a6";

    public enum Method { GET, POST };
    public const string AUTHORIZE = "https://graph.facebook.com/oauth/authorize";
    public const string ACCESS_TOKEN = "https://graph.facebook.com/oauth/access_token";
    public string CALLBACK_URL = pageURL1 + "Plugin/PluginFBCallback.aspx";
    ...
    public string ConsumerKey
    {
        get
        {
            ...
            {
                _consumerKey = APIKey + "";//Your application ID
            }
            return _consumerKey;
        }
    ...
    public string ConsumerSecret
    {
        get
        {
            ...
            {
                _consumerSecret = Secret + ""; //Your application secret
            }
