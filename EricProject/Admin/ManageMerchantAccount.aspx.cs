...
public partial class Admin_ManageMerchantAccount : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            litCustomerManagement.Text = "<li id='lilitCustomerManagement' class=\"forms\"><a href=\"" + ConfigurationManager.AppSettings["pageURL"] + "Admin/CustomerManagement.aspx\"><span>Customer Management</span></a></li>";
            ...
            litManageMerchantAccounts.Text = "<li id='liManagemerchantaccounts' style=\"display:none\" class=\"ui\"><a href=\"" + ConfigurationManager.AppSettings["pageURL"] + "Admin/ManageMerchantAccount.aspx\"  class=\"active\"><span>Manage Merchant Account</span></a></li>";
