...
public partial class FAQ_Management : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            litFAQManagement.Text = "<li id='lilitFAQManagement' style=\"display:none\" class=\"typo\"><a href=\"" + ConfigurationManager.AppSettings["pageURL"] + "Admin/FAQ_Management.aspx\" class=\"active\"><span>FAQ Management</span></a></li>";
        }
    }
}