...
public partial class Admin_AddNewSubAdmin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //HtmlAnchor aAddNewSubadmin = new HtmlAnchor();
        //aAddNewSubadmin = (HtmlAnchor)Page.Master.FindControl("aAddNewSubadmin");
        //aAddNewSubadmin.InnerHtml = "<a href=\"" + ConfigurationManager.AppSettings["pageURL"] + "Admin/AddNewSubAdmin.aspx\"  id=\"aAddNewSubadmin\" class=\"active\"><span>Add New Subadmin</span></a>";
        if (!IsPostBack)
        {
