...
public partial class Admin_CustomerManagement : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            litCustomerManagement.Text = "<li id='lilitCustomerManagement' style=\"display:none\"  class=\"forms\"><a href=\"" + ConfigurationManager.AppSettings["pageURL"] + "Admin/CustomerManagement.aspx\" class=\"active\"><span>Customer Management</span></a></li>";
