...
public partial class Master_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            litDashboard.Text = "<li id='lilitDashboard' style=\"display:none\" class=\"dash\"><a href=\"" + ConfigurationManager.AppSettings["pageURL"] + "Admin/Default.aspx\"  class=\"active\"><span>Dashboard</span></a></li>";
