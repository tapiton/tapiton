<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteMerchant.Master" AutoEventWireup="true" CodeBehind="AutoSubscription.aspx.cs" Inherits="EricProject.Site.AutoSubscription" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                                    ...
                                    <div class="botpartSml" style="min-height: 350px;">
                                        ...
                                        <table style="width: 100%" cellpadding="0" cellspacing="10">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCardnumber" runat="server" Width="16%" onkeypress="return isNumberKey(event)" CssClass="inptredeem" MaxLength="16"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="text-align: left">
                                                    ...
                                                    <td style="text-align: right">
                                                        <asp:Button ID="btnRedeem" runat="server" Text="Save" OnClientClick="return CheckDate();" OnClick="btnRedeem_Click" class="formbtnBig" /></td>
                                            </tr>
                                        </table>
                                        <div class="clr"></div>
                                    </div>
    ...
    <div id="progressdiv" runat="server" style="position: fixed; top: 200px; width: 100%; z-index: 2; display: none;" align="center">
        <div style="width: 300px; height: 200px;">
            <center>
                <img src="/images/ajax-loader.gif" width="100px" height="100px" alt="" /><br />
