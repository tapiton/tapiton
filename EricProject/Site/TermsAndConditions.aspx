<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SiteMaster.Master" AutoEventWireup="true"
    CodeBehind="TermsAndConditions.aspx.cs" Inherits="Site_TermsAndConditions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div id="bannerCntr" class="subpageinner">
        <div class="bannercenter">
            ...
            <div class="searchFaqBox">
                <div class="Subleft" style="font-weight:bold;">
                    <h2>
    ...
    <script type="text/javascript">
        function FunctionOnLoad() {
            EricProject.WebServices.Admin.BindStaticContentByID(5, EditStaticContent);
        }
