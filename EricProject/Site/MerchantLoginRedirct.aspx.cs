...
{
    public partial class MerchantLoginRedirct : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    litMsg.Text += " You are already logged in with the email account : <span style=\"color:#7ebb01;font-weight:bold;\">" + Session["MerchantEmailId"].ToString() + "</span>. You will be redirected to your dashboard for this account in a moment.";
                    litMsg.Text += "<br /><br />";
                    ...
                    Session["MerchantEmailIdNew"] = Session["MerchantEmailId"];
