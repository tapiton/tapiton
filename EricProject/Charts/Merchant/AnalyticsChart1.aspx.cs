        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (flag == false)
                {
                    ...
                    {
                        obj.TimePeriod = Convert.ToInt32(Session["TimePeriod"] + "");
                        this.GraphXAxisType();
                    }
                    else
                    {
